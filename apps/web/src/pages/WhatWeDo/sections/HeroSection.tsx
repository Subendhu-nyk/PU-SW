      ...
      <div className="relative z-10 h-full flex items-center">
        <div className="container mx-auto px-6 lg:px-16">
          <motion.div
            ...
            className="max-w-md"
          >
            <h1 className="font-serif text-5xl md:text-8xl font-light tracking-[0.1em] text-white leading-[0.95] mb-8 uppercase">
              {WhatWeDoHeroData.headingLine1}<br />{WhatWeDoHeroData.headingLine2}
            </h1>
